...
struct EditablePassCard: View {
    ...
    private func cardContent(size: CGSize) -> some View {
        if #available(iOS 27.0, *) {
            cardContentPostiOS27(size: size)
        } else {
            cardContentPreiOS27(size: size)
        }
    }
        ...
        ZStack {
            ...
            .overlay {
                if isSigningPass {
                    ...
                    .clipShape(signingOverlayClipShapePost27)
                    .overlay {
                        VStack(spacing: 8) {
    ...
    @ViewBuilder
    private func cardContentPreiOS27(size: CGSize) -> some View {
        ZStack {
            ZStack {
